...
extern void print_matrix(char *desc, MKL_INT m, MKL_INT n, MKL_Complex16 *a,
                         MKL_INT lda);
...
int main() {
  ...
  MKL_Complex16 a[LDA * N] = {
      ...
      {-4.30, -7.10}, {-6.47, 2.52},  {-6.51, -2.67}, {-5.86, 7.38},
      {1.27, 7.29},   {8.90, 6.92},   {-8.82, 1.25},  {5.41, 5.37}};
  MKL_Complex16 b[LDB * N] = {{8.33, -7.32}, {-6.11, -3.81}, {-6.18, -4.80},
                              {0.14, -7.71}, {-5.71, -2.80}, {1.41, 3.40},
                              {-1.60, 3.08}, {8.54, -4.05}};
...
void print_matrix(char *desc, MKL_INT m, MKL_INT n, MKL_Complex16 *a,
                  MKL_INT lda) {
  MKL_INT i, j;
  printf("\n %s\n", desc);
  for (i = 0; i < m; i++) {
